...
void reescreverUsuario(int cor1, int cor2, int cor3, int x, int y){
	...
	textcolor(cor2);
	criar_caixinha(x,y + 4,30,2,CANTO1,CANTO2,CANTO3,CANTO4,LADO,CIMA1);
	gotoxy(x + 6,y + 5);
	printf("CONSULTAR PUBLICA%c%cES",128,229);
	
	textcolor(cor3);
	criar_caixinha(x,y + 8,30,2,CANTO1,CANTO2,CANTO3,CANTO4,LADO,CIMA1);
	gotoxy(x + 10,y + 9);
...
void login(){
	...
	if(administrador != NULL){
		...
		FILE* cadastrar = fopen(cadastrar_arq,"rb");
		administrador = fopen(funcionario_arq,"rb");
		...
		verificacaoInt(38,14,campo2,matriculaMenu,12,BRIGHTWHITE);
...
void SenhaAtual(){
	...
	}while(senhaatual[0] == '\0' || tamanho > 6 || encontrou != TRUE);
...
int opUsuario(){
	...
	reescreverUsuario(GREENWATER,BRIGHTWHITE,BRIGHTWHITE,45,9);
	...
	do{
		...
		switch(op){
			case 0:
				op = 3;
				reescreverUsuario(BRIGHTWHITE,BRIGHTWHITE,GREENWATER,45,9);
				break;
			...
			case 2:
				reescreverUsuario(BRIGHTWHITE,GREENWATER,BRIGHTWHITE,45,9);
				break;
			case 3:
				reescreverUsuario(BRIGHTWHITE,BRIGHTWHITE,GREENWATER,45,9);
				break;
...
void consultaPublicacao(){
	...
	if(publicacao == NULL){ 
		...
		quadrado(GREENWATER);
		criar_caixinha(46,3,30,2,CANTO1,CANTO2,CANTO3,CANTO4,LADO,CIMA1);
		textcolor(BRIGHTWHITE);
		gotoxy(58,4);
		printf("CONSULTA");
...
void senhaconfirmar(char confirmar[], char senha3[], char senha4[], int x, int y){
	...
	}while(senha1[0] == '\0' || tamanho > 6 || encontrou == TRUE);
...
void devolucao(){
	...
	//Matricula
	verificacaoInt(38,14,campo2,devolver.matricula,12,BRIGHTWHITE);
	...
	//Codigo
	verificacaoInt(38,17,codigo1,devolver.codigo,20,BRIGHTWHITE);
